...
import Helados.Cono;
import Helados.Cilindro;
import Helados.Circulo;
import figurasHerencia.*;
...
public class Pizarra extends javax.swing.JFrame {
    ...
    private void Propiedades(int tipo)
    {
        String propiedades="";
        ...
        if(tipo==4)
        {
            propiedades+="Centro: ("+this.cilindrito.getX()+", "+this.cilindrito.getY()+")\n"
                    + "Radio: "+this.cilindrito.getDim1()+"\n"
                    + "Altura: "+this.cilindrito.getDim2()+"\n"
    ...
    private void dibujarCirculo()
    {
        ...
        this.setColor();
        this.pintor.drawOval(this.circulito.getX()-this.circulito.getDim1(), this.circulito.getY()-this.circulito.getDim1(), 2*this.circulito.getDim1(),2*this.circulito.getDim1());
    ...
    private void dibujarEsfera()
    {
        ...
        this.setColor();
        this.pintor.drawOval(this.esferita.getX()-this.esferita.getDim1(), this.esferita.getY()-this.esferita.getDim1(), 2*this.esferita.getDim1(),2*this.esferita.getDim1());
        this.pintor.fillOval(this.esferita.getX()-this.esferita.getDim1(), this.esferita.getY()-this.esferita.getDim1()+5*this.esferita.getDim1()/6,2*this.esferita.getDim1(),this.esferita.getDim1()/3);
        this.setColor();
    ...
    private void dibujarCilindro()
    {
        ...
        this.pintor.fillOval(this.cilindrito.getX()-this.cilindrito.getDim1(), this.cilindrito.getY()-this.cilindrito.getDim1()+5*this.cilindrito.getDim1()/6-this.cilindrito.getDim2(),2*this.cilindrito.getDim1(),this.cilindrito.getDim1()/3);        
        
        this.pintor.drawLine(this.cilindrito.getX()-this.cilindrito.getDim1(), this.cilindrito.getY(), this.cilindrito.getX()-this.cilindrito.getDim1(), this.cilindrito.getY()-this.cilindrito.getDim2());
        this.pintor.drawLine(this.cilindrito.getX()+this.cilindrito.getDim1(), this.cilindrito.getY(), this.cilindrito.getX()+this.cilindrito.getDim1(), this.cilindrito.getY()-this.cilindrito.getDim2());
    ...
    private void dibujarCono()
    {
        ...
        this.pintor.fillOval(this.conito.getX()-this.conito.getDim1(), this.conito.getY()-this.conito.getDim1()+5*this.conito.getDim1()/6,2*this.conito.getDim1(),this.conito.getDim1()/3);
        ...
        if(respuesta==1)
        {
            propiedades+="Centro: ("+this.conito.getX()+", "+this.conito.getY()+")\n"
                    + "Radio: "+this.conito.getDim1()+"\n"
                    + "Altura: "+this.conito.getDim2()+"\n"
