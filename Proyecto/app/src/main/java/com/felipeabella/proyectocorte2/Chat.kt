...
class Chat: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Doble exclamación es dar una orden obligatoria

        //Lógica data recycleview
        ...
        sendButton.setOnClickListener {
            ...
            if (message.isNotEmpty()) {
                ...
                mDbRef.child("chats").child(senderRoom!!).child("messages").push().setValue(messageObject).addOnCompleteListener {
